...
for(var i in menu.sections) {	
	...
	for(var j in menu.sections[i].items) {
		...
		for(var k in menu.sections[i].items[j].sizes) {
			...
			output += "<input type='checkbox' id='" + menu.sections[i].items[j].name + " " + menu.sections[i].items[j].sizes[k].size + "' name='" + menu.sections[i].items[j].name + " " + menu.sections[i].items[j].sizes[k].size + "' onchange='showQuantity(" + menu.sections[i].items[j].name + " " + menu.sections[i].items[j].sizes[k].size + ")'>"
...
function showQuantity(checkInfo) {
	if(checkInfo.checked == true) {
		var x = document.getElementsByClassName(checkInfo);
